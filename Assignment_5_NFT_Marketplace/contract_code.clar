...
(define-public (buy-nft (listing-id uint) (nft-contract <nft-trait>))
    (let (
        ...
        (asserts! (is-eq (get nft-contract listing) (contract-of nft-contract)) ERR-NOT-FOUND)
...
(define-public (cancel-listing (listing-id uint) (nft-contract <nft-trait>))
    (let (
        ...
        (try! (as-contract (contract-call? nft-contract transfer nft-id tx-sender (get seller listing))))
